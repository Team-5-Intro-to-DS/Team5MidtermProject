...
## Simple Assault  
### Models: variable: "District" and "Month"  
...
### Models variable: "District" and "Weekday"

```{r}
# create dataframe having "Category", "Weekday", "District", "Year", and "Count" as its column
DF_WM3 <- DF_WM
DF_WM3$Count <- c(rep(1,nrow(DF_WM3)))

DF_WM3 = aggregate(x=DF_WM3[c("Count")], 
                   by=list(DF_WM3$Arrest_Category, DF_WM3$Weekday,
                           DF_WM3$Offense_Location_District, DF_WM3$Arrest_Year),
                   sum)

colnames(DF_WM3)[1:4] = c("Category", "Weekday", "District", "Year")
DF_WM3 %>% subset(., District != '#N/A') %>% subset(., District != 'Unk') %>% subset(., District != 'UNKNOWN') -> DF_WM3
```
...
createDF <- function(df, cat, y){
  df_temp = subset(df, Category==cat & Year==y, select=c(District, Weekday, Count))
  D <- c('1D','2D','3D','4D','5D','6D','7D' )
  W <- c('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday')
  for(d in D){
    for(w in W){
      if(nrow(df_temp[df_temp$District==d & df_temp$Weekday==w,])==0){
        add_data = c(d, w, 0)
        df_temp = rbind(df_temp, add_data)
      }
    }
...
DF_SA_2016 = createDF(DF_WM3, 'Simple Assault', '2016')
model1.sa.2016 <- glm(Count ~ 1, data = DF_SA_2016, family = poisson)
model2.sa.2016 <- glm(Count ~ District, data = DF_SA_2016, family = poisson)
model3.sa.2016 <- glm(Count ~ Weekday, data = DF_SA_2016, family = poisson)
model4.sa.2016 <- glm(Count ~ District + Weekday, data = DF_SA_2016, family = poisson)
model5.sa.2016 <- glm(Count ~ District * Weekday, data = DF_SA_2016, family = poisson)
summary(model1.sa.2016)
summary(model2.sa.2016)
summary(model3.sa.2016)
summary(model4.sa.2016)
...
DF_SA_2017 = createDF(DF_WM3, 'Simple Assault', '2017')
model1.sa.2017 <- glm(Count ~ 1, data = DF_SA_2017, family = poisson)
model2.sa.2017 <- glm(Count ~ District, data = DF_SA_2017, family = poisson)
model3.sa.2017 <- glm(Count ~ Weekday, data = DF_SA_2017, family = poisson)
model4.sa.2017 <- glm(Count ~ District + Weekday, data = DF_SA_2017, family = poisson)
model5.sa.2017 <- glm(Count ~ District * Weekday, data = DF_SA_2017, family = poisson)
summary(model1.sa.2017)
summary(model2.sa.2017)
summary(model3.sa.2017)
summary(model4.sa.2017)
...
DF_SA_2018 = createDF(DF_WM3, 'Simple Assault', '2018')
model1.sa.2018 <- glm(Count ~ 1, data = DF_SA_2018, family = poisson)
model2.sa.2018 <- glm(Count ~ District, data = DF_SA_2018, family = poisson)
model3.sa.2018 <- glm(Count ~ Weekday, data = DF_SA_2018, family = poisson)
model4.sa.2018 <- glm(Count ~ District + Weekday, data = DF_SA_2018, family = poisson)
model5.sa.2018 <- glm(Count ~ District * Weekday, data = DF_SA_2018, family = poisson)
summary(model1.sa.2018)
summary(model2.sa.2018)
summary(model3.sa.2018)
summary(model4.sa.2018)
...
DF_SA_2019 = createDF(DF_WM3, 'Simple Assault', '2019')
model1.sa.2019 <- glm(Count ~ 1, data = DF_SA_2019, family = poisson)
model2.sa.2019 <- glm(Count ~ District, data = DF_SA_2019, family = poisson)
model3.sa.2019 <- glm(Count ~ Weekday, data = DF_SA_2019, family = poisson)
model4.sa.2019 <- glm(Count ~ District + Weekday, data = DF_SA_2019, family = poisson)
model5.sa.2019 <- glm(Count ~ District * Weekday, data = DF_SA_2019, family = poisson)
summary(model1.sa.2019)
summary(model2.sa.2019)
summary(model3.sa.2019)
summary(model4.sa.2019)
...
DF_SA_2020 = createDF(DF_WM3, 'Simple Assault', '2020')
model1.sa.2020 <- glm(Count ~ 1, data = DF_SA_2020, family = poisson)
model2.sa.2020 <- glm(Count ~ District, data = DF_SA_2020, family = poisson)
model3.sa.2020 <- glm(Count ~ Weekday, data = DF_SA_2020, family = poisson)
model4.sa.2020 <- glm(Count ~ District + Weekday, data = DF_SA_2020, family = poisson)
model5.sa.2020 <- glm(Count ~ District * Weekday, data = DF_SA_2020, family = poisson)
summary(model1.sa.2020)
summary(model2.sa.2020)
summary(model3.sa.2020)
summary(model4.sa.2020)
...
DF_SA_2021 = createDF(DF_WM3, 'Simple Assault', '2021')
model1.sa.2021 <- glm(Count ~ 1, data = DF_SA_2021, family = poisson)
model2.sa.2021 <- glm(Count ~ District, data = DF_SA_2021, family = poisson)
model3.sa.2021 <- glm(Count ~ Weekday, data = DF_SA_2021, family = poisson)
model4.sa.2021 <- glm(Count ~ District + Weekday, data = DF_SA_2021, family = poisson)
model5.sa.2021 <- glm(Count ~ District * Weekday, data = DF_SA_2021, family = poisson)
summary(model1.sa.2021)
summary(model2.sa.2021)
summary(model3.sa.2021)
summary(model4.sa.2021)
...
### Model selection  
#### Deviance
I will use "residual deviance" to test the below hypothesis at a significance level $\alpha=0.05$:
$$H_0: \ \rm{Reduced \ model \ is \ true.}$$
$$H_1: \ \rm{Satureated \ model \ (Model \ 5) \ is \ true}$$
To test the hypothesis, I will calculate p-value:  
...
**2016**
```{r}
xkabledply(model4.sa.2016)
```

**2017**
```{r}
xkabledply(model5.sa.2017)
```
...
**2019**
```{r}
xkabledply(model4.sa.2019)
```

**2020**
```{r}
xkabledply(model4.sa.2020)
```

**2021**
```{r}
xkabledply(model2.sa.2021)
```
...
for(d in D){
  for(w in W){
    if(nrow(DF_postCOVID_SA[DF_postCOVID_SA$District==d & DF_postCOVID_SA$Weekday==w,])==0){
      add_data = c('Simple Assault', d, w, 0)
      DF_postCOVID_SA = rbind(DF_postCOVID_SA, add_data)
    }
  }
}
DF_postCOVID_SA$Count = as.integer(DF_postCOVID_SA$Count)
```
