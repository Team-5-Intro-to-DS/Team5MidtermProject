...
for(j in region){
  ...
  tmpDF_SIM<-subset(DF_WM , Arrest_Category=="Simple Assault"&Arrest_Location_District==j&Weekday==k)
...
for(j in region){
  ...
  tmpDF_TRA<-subset(DF_WM , Arrest_Category=="Traffic Violations" &Arrest_Location_District==j&Weekday==k)
...
for(j in region){
  ...
  tmpDF_Theft<-subset(DF_WM , Arrest_Category=="Traffic Violations" &Arrest_Location_District==j&Weekday==k)
