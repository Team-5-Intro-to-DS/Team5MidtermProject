...
`Arrest_Hour` of data in 2019 contains only 1 - 12, so we removed the data in 2019 in the below plot. 

```{r}
#by_hour <- DF %>% subset(.,Arrest_Year%in%c(2016,2017,2018,2020,2021)) %>%
#           group_by(Arrest_Hour) %>% 
#           dplyr::summarise(Total = n())
#by_hour
...
#ggplot(by_hour, aes(Arrest_Hour, Total, color = Arrest_Hour)) + 
#    geom_line() + 
#    ggtitle("Crimes By Hour (except for 2019 data)") + 
#    xlab("Hour of the Day") + 
#    ylab("Total Crimes") 
```
...
```{r}
#wm_by_hour <- df_wm %>% subset(.,Arrest_Year%in%c(2016,2017,2018,2020,2021)) %>%
#           group_by(Arrest_Hour) %>% 
#           dplyr::summarise(Total = n())
#wm_by_hour
...
#ggplot(wm_by_hour, aes(Arrest_Hour, Total, color = Arrest_Hour)) + 
#    geom_line() + 
#    ggtitle("White Males - Crimes By Hour (except for 2019 data)") + 
#    xlab("Hour of the Day") + 
#    ylab("Total Crimes")
```
