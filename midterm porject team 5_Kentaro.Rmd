...
```
The column names of the data in 2016 and 2017 are not the same with others. The below table shows the column names of the data in 2016 and the data in 2016.
...
## Drop Some Rows and Revise Some Values 
...
Therefore, we will covert these values in 2021 into the correspond values in other years.  

The structure of data frame after data shaping is shown in the below table.
...
**`r crime_2016[1:3]`, and `r crime_2016[4]`** are included in the above table all years. **`r crime_2018[5]`** is in three different years, and **`r crime_2016[5]`, `r crime_2018[6]`, and `r crime_2020[5]`** are in two different years. Since these crimes seems to be major crimes, we will analyze these crimes.


### Line plots
To see the trend of the above major crimes, we create a line plot as follows.
...
**"Simple Assault"**, **"Traffic Violations"**, and **"Theft"** have clearly declined since 2020. On the other, **"Offenses Against Family & Children"** has increased in 2020 and 2021 compared to previous years. In the following, we will analyze these four crimes in detail.
